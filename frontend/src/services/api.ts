...
export const apiService = {
  ...
  superadmin: {
    ...
    getSchool: (id: string) =>
      api.get<ApiResponse>(`/superadmin/schools/${id}`),
    ...
    getSchoolDetails: (id: string) =>
      api.get<ApiResponse>(`/superadmin/schools/${id}/details`), // Full details including admin credentials

    // Admin management
    assignAdmin: (schoolId: string, adminData: any) =>
    ...
    resetPassword: (id: string, data: any) =>
      api.put<ApiResponse>(`/superadmin/schools/${id}/reset-password`, data),

    // API management
    regenerateApiKey: (schoolId: string) =>
      api.post<ApiResponse>(
        `/superadmin/schools/${schoolId}/regenerate-api-key`
      ),

    // System settings
    getSystemSettings: () =>
      api.get<ApiResponse>("/superadmin/system/settings"),
    ...
    getAllSchools: (params?: any) =>
      api.get<ApiResponse>("/superadmin/schools", { params }),
    assignSchoolAdmin: (schoolId: string, adminData: any) =>
      api.post<ApiResponse>(`/superadmin/schools/${schoolId}/admin`, adminData),
  },
  ...
  admin: {
    ...
    deleteStudent: (id: string) =>
      api.delete<ApiResponse>(`/admin/students/${id}`),
    ...
    deleteTeacher: (id: string) =>
      api.delete<ApiResponse>(`/admin/teachers/${id}`),
  ...
  parent: {
    ...
    getChildAttendance: (id: string) =>
      api.get<ApiResponse>(`/parent/child/${id}/attendance`),
    getChildGrades: (id: string) =>
      api.get<ApiResponse>(`/parent/child/${id}/grades`),
    getChildHomework: (id: string) =>
      api.get<ApiResponse>(`/parent/child/${id}/homework`),
    getChildNotices: (id: string) =>
      api.get<ApiResponse>(`/parent/child/${id}/notices`),
  },
