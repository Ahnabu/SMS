  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">My Academic Overview</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg shadow-sm p-4 sm:p-6 border border-purple-200">
            <div className="flex items-center">
              ...
              <div className="ml-3 sm:ml-4">
                <p className="text-xs sm:text-sm text-purple-700 font-medium">Today's Classes</p>
                <p className="text-lg sm:text-2xl font-bold text-purple-900">{dashboardData?.todayClasses || 0}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Recent Grades</h3>
            <div className="space-y-2 sm:space-y-3">
              {dashboardData?.recentGrades?.slice(0, 5).map((grade: any, index: number) => (
                <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg border">
                  <span className="text-sm font-medium text-gray-900 truncate">{grade.subject}</span>
                  <span className="text-sm font-bold text-indigo-600 ml-2">{grade.grade}</span>
                </div>
              )) || (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Upcoming Assignments</h3>
            <div className="space-y-2 sm:space-y-3">
...
const AttendanceView: React.FC = () => (
  <div className="space-y-6">
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
      <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">My Attendance</h2>
      <p className="text-gray-500 text-sm sm:text-base">Attendance view interface will be implemented here.</p>
    </div>
  </div>
);
...
const GradeView: React.FC = () => (
  <div className="space-y-6">
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
      <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">My Grades</h2>
      <p className="text-gray-500 text-sm sm:text-base">Grade view interface will be implemented here.</p>
    </div>
  </div>
);
...
const HomeworkView: React.FC = () => (
  <div className="space-y-6">
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
      <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">My Homework</h2>
      <p className="text-gray-500 text-sm sm:text-base">Homework view interface will be implemented here.</p>
    </div>
  </div>
);
...
const ScheduleView: React.FC = () => (
  <div className="space-y-6">
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
      <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">My Class Schedule</h2>
      <p className="text-gray-500 text-sm sm:text-base">Schedule view interface will be implemented here.</p>
    </div>
  </div>
);
...
const CalendarView: React.FC = () => (
  <div className="space-y-6">
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
      <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Academic Calendar</h2>
      <p className="text-gray-500 text-sm sm:text-base">Calendar view interface will be implemented here.</p>
    </div>
  </div>
);
